...
-- 1. Bảng lưu trữ Firestore giả lập (fallback cho các collection động)
...
-- 4. Bảng Thông báo (NotificationBell)
...
-- 5. Bảng Yêu cầu thay đổi quyền (Role Request)
...
-- 6. Bảng Tin nhắn Chat (GiaiLaoChat)
...
-- 7. Bảng Sự cố Gemba (Gemba & Tự Gemba)
...
-- 8. Bảng Vi phạm Hút thuốc (HutThuocToilet & GiamSatNhaRac)
...
-- 9. Bảng Đăng ký Ca làm việc hàng tuần (Calamviec)
...
-- 10. Bảng Danh mục hóa chất & Tồn kho MSDS (msds & storage)
